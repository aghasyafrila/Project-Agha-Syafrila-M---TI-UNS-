...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Des 2021 pada 20.22
...
INSERT INTO `set_poin` (`id_tanaman`, `nama_tanaman`, `ph`, `ppm`, `room_humidity`, `water_temperature`, `waktu_input`) VALUES
(1, 'Monstera', 7, 0, 23, 27, '2019-08-15 17:11:15'),
(2, 'Caladium', 4, 3, 23, 17, '2019-08-16 11:13:05'),
(6, 'Aglonema', 7, 4, 23, 17, '2021-12-18 18:10:13'),
(7, 'Anggrek', 4, 3, 23, 17, '2019-08-16 11:13:05');
...
--
-- Indeks untuk tabel `room_humidity`
--
ALTER TABLE `room_humidity`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `set_poin`
--
ALTER TABLE `set_poin`
  ADD PRIMARY KEY (`id_tanaman`);

--
-- Indeks untuk tabel `tbl_tanaman`
--
...
--
-- Indeks untuk tabel `user_action`
--
...
--
-- Indeks untuk tabel `water_temperature`
--
...
--
-- AUTO_INCREMENT untuk tabel `room_humidity`
--
ALTER TABLE `room_humidity`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `set_poin`
--
ALTER TABLE `set_poin`
  MODIFY `id_tanaman` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT untuk tabel `tbl_tanaman`
--
ALTER TABLE `tbl_tanaman`
...
--
-- AUTO_INCREMENT untuk tabel `user_action`
--
ALTER TABLE `user_action`
...
--
-- AUTO_INCREMENT untuk tabel `water_temperature`
--
ALTER TABLE `water_temperature`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
