                            ...
                            <form method="post" action="<?php echo base_url() ?>anggota/submit" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="alamat" id="alamat">
                                        ...
                                        <option value="Nama Provinsi 1">Jawa Barat</option>
                                        <option value="Nama Provinsi 2">Jawa Tengah</option>
                                        <option value="Nama Provinsi 3">Jawa Timur</option>
                                        <option value="Nama Provinsi 4">Kalimantan Barat</option>
                                        <option value="Nama Provinsi 5">Bali</option>
                                        <option value="Nama Provinsi 6">DKI Jakarta</option>
                                        <option value="Nama Provinsi 7">Sulawesi</option>
                                        <option value="Nama Provinsi 8">Aceh</option>
                                        <option value="Nama Provinsi 9">NTT</option>
                                    </select>
                                    </div>
                                </div>
                                <div class="form-group">
